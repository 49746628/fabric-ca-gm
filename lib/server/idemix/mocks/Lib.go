...
func (_m *Lib) CreateCRI(key interface{}, unrevokedHandles []*FP256BN.BIG, epoch int, alg idemix.RevocationAlgorithm, rng *amcl.RAND) (*idemix.CredentialRevocationInformation, error) {
	ret := _m.Called(key, unrevokedHandles, epoch, alg, rng)

	var r0 *idemix.CredentialRevocationInformation
	if rf, ok := ret.Get(0).(func(interface{}, []*FP256BN.BIG, int, idemix.RevocationAlgorithm, *amcl.RAND) *idemix.CredentialRevocationInformation); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(interface{}, []*FP256BN.BIG, int, idemix.RevocationAlgorithm, *amcl.RAND) error); ok {
...
func (_m *Lib) GenerateLongTermRevocationKey() (interface{}, error) {
	ret := _m.Called()
